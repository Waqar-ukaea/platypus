...
# tar full results into compressed file for artifact upload
tar -cvf "regression_test_${analysisType}_full.tar" *.tar

# tar results summaries into compressed file for artifact upload
